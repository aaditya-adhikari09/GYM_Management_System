...
@section('middlesection')
    ...
    <head>
        ...
        <link rel="stylesheet" href={{ asset('frontcss/jquery.mCustomScrollbar.min.css') }}>
                ...
                <div class="menu_sitbar">
                    <ul class="menu">
                        <li><button type="button">
                                <img style="" onclick="openNav()" src={{ asset('images/menu_icon.png') }}
                                    alt="#" />
                            </button>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="banner_text">
                                        ...
                                        <a class="get_btn" href="#about" role="button">About Protien</a> <a
                                            class="get_btn" href="#contact" role="button">Contact Us</a>
                                    </div>
                                </div>
                                <div class="col-md-7">
            ...
            <div class="footer">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class=" col-md-3 col-sm-6">
                            <p class="variat">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim Lorem ipsum </p>
                        </div>
